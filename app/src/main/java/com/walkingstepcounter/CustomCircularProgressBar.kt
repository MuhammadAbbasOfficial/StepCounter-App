...
class CustomCircularProgressBar @JvmOverloads constructor(
    ...
    init {
        context.theme.obtainStyledAttributes(
            ...
            try {
                ...
                maxProgress = getFloat(R.styleable.CustomCircularProgressBar_maxProgress, maxProgress)
                progressPaint.color = getColor(R.styleable.CustomCircularProgressBar_progressColor, Color.BLUE)
                paint.color = getColor(R.styleable.CustomCircularProgressBar_backgroundColor, Color.GRAY)
                textPaint.color = getColor(R.styleable.CustomCircularProgressBar_textColor, Color.parseColor("#00F1FF"))
                textPaint.textSize = getDimension(R.styleable.CustomCircularProgressBar_textSize, 80f)
                circleMargin = getDimension(R.styleable.CustomCircularProgressBar_circleMargins, circleMargin)
                walkingStepsCounter = getString(R.styleable.CustomCircularProgressBar_walkingStepsCounter) ?: "0"
                letterSpacing = getFloat(R.styleable.CustomCircularProgressBar_letterSpacing, 0f)
                textPaint.letterSpacing = letterSpacing
                belowText = getString(R.styleable.CustomCircularProgressBar_totalSteps) ?: "" // Get the belowText from XML
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val radius = (widthWithPadding.coerceAtMost(heightWithPadding) / 2f) - circleMargin - progressPaint.strokeWidth
